...
│   │   ├── variables.tf
│   │   └── versions.tf
│   └── modules/resume_stack/         # 共通モジュール
│       ├── main.tf                   # Cloud Run / GCS / Secret Manager / SA / IAM
│       ├── variables.tf
│       └── outputs.tf
├── .github/workflows/
